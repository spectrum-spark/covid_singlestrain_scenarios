function [SIM_HOSP_DATA,hosp_indices,individual_characteristics,all_trans_probs,vax_strata,Admission_Status]=clinical_pathways_immunity_relsev_func(state_modelled,scenario_name,rel_sev)
...
OR_warddeath_delta=2.33*rel_sev;
...
OR_ICUdeath_delta=2.33*rel_sev;
...
OR_postICUdeath_delta=2.33*rel_sev;
