function [data_frame,SIM_HOSP_DATA,hosp_indices,individual_characteristics,all_trans_probs,vax_strata,Admission_Status]=clinical_pathways_immunity_relsev2_func(state_modelled,scenario_name,rel_sev,omicron_los)
...
if omicron_los
    ...
    %ordering: Ward discharge (no ICU), Ward death (no ICU), preICU ward, ICU
    %death, ICU to ward death, ICU to ward discharge, postICU death,
    %postICU to discharge
    
    %note I've used same LoS estimates as for Delta for PostICU to death
    post_los_means = [2.02, 3.89, 0.82, 10.6, 4.43, 4.43, 3.01, 3.34;
                      2.02, 3.89, 0.82, 10.6, 4.43, 4.43, 3.01, 3.34;
                      2.02, 3.89, 0.82, 10.6, 4.43, 4.43, 3.01, 3.34;
                      2.02, 3.89, 0.82, 10.6, 4.43, 4.43, 3.01, 3.34;
                      2.02, 3.89, 0.82, 10.6, 4.43, 4.43, 3.01, 3.34;
                      2.02, 3.89, 0.82, 10.6, 4.43, 4.43, 3.01, 3.34;
                      2.02, 3.89, 0.82, 10.6, 4.43, 4.43, 3.01, 3.34;
                      2.02, 3.89, 0.82, 10.6, 4.43, 4.43, 3.01, 3.34;
                      3.19, 3.89, 1.30, 10.6, 5.06, 5.06, 3.01, 4.74;
                      3.19, 3.89, 1.30, 10.6, 5.06, 5.06, 3.01, 4.74;
                      3.19, 3.89, 1.30, 10.6, 5.06, 5.06, 3.01, 4.74;
                      3.19, 3.89, 1.30, 10.6, 5.06, 5.06, 3.01, 4.747;
                      3.19, 3.89, 1.30, 10.6, 5.06, 5.06, 3.01, 4.74;
                      3.19, 3.89, 1.30, 10.6, 5.06, 5.06, 3.01, 4.74;
                      4.71, 7.21, 1.92, 8.17, 3.71, 3.71, 4.42, 4.99;
                      4.71, 7.21, 1.92, 8.17, 3.71, 3.71, 4.42, 4.99;
                      4.71, 7.21, 1.92, 8.17, 3.71, 3.71, 4.42, 4.99];
    
    
    post_los_shapes = [1.04, 1.07, 0.53, 1.61, 1.49, 1.49, 1.53, 1.75;
                       1.04, 1.07, 0.53, 1.61, 1.49, 1.49, 1.53, 1.75;
                       1.04, 1.07, 0.53, 1.61, 1.49, 1.49, 1.53, 1.75;
                       1.04, 1.07, 0.53, 1.61, 1.49, 1.49, 1.53, 1.75;
                       1.04, 1.07, 0.53, 1.61, 1.49, 1.49, 1.53, 1.75;
                       1.04, 1.07, 0.53, 1.61, 1.49, 1.49, 1.53, 1.75;
                       1.04, 1.07, 0.53, 1.61, 1.49, 1.49, 1.53, 1.75;
                       1.04, 1.07, 0.53, 1.61, 1.49, 1.49, 1.53, 1.75;
                       1.00, 1.07, 0.51, 1.61, 1.70, 1.70, 1.53, 2.48;
                       1.00, 1.07, 0.51, 1.61, 1.70, 1.70, 1.53, 2.48;
                       1.00, 1.07, 0.51, 1.61, 1.70, 1.70, 1.53, 2.48;
                       1.00, 1.07, 0.51, 1.61, 1.70, 1.70, 1.53, 2.48;
                       1.00, 1.07, 0.51, 1.61, 1.70, 1.70, 1.53, 2.48;
                       1.00, 1.07, 0.51, 1.61, 1.70, 1.70, 1.53, 2.48;
                       1.26, 1.36, 0.64, 1.24, 1.25, 1.25, 2.26, 2.61;
                       1.26, 1.36, 0.64, 1.24, 1.25, 1.25, 2.26, 2.61;
                       1.26, 1.36, 0.64, 1.24, 1.25, 1.25, 2.26, 2.61];
    ...
    post_los_uppers=[ 2.09, 5.00, 0.94, 15.01, 5.25, 5.25, 3.02, 4.15;
                      2.09, 5.00, 0.94, 15.01, 5.25, 5.25, 3.02, 4.15;
                      2.09, 5.00, 0.94, 15.01, 5.25, 5.25, 3.02, 4.15;
                      2.09, 5.00, 0.94, 15.01, 5.25, 5.25, 3.02, 4.15;
                      2.09, 5.00, 0.94, 15.01, 5.25, 5.25, 3.02, 4.15;
                      2.09, 5.00, 0.94, 15.01, 5.25, 5.25, 3.02, 4.15;
                      2.09, 5.00, 0.94, 15.01, 5.25, 5.25, 3.02, 4.15;
                      2.09, 5.00, 0.94, 15.01, 5.25, 5.25, 3.02, 4.15;
                      3.28, 5.00, 1.44, 15.01, 5.35, 5.35, 3.02, 5.46;
                      3.28, 5.00, 1.44, 15.01, 5.35, 5.35, 3.02, 5.46;
                      3.28, 5.00, 1.44, 15.01, 5.35, 5.35, 3.02, 5.46;
                      3.28, 5.00, 1.44, 15.01, 5.35, 5.35, 3.02, 5.46;
                      3.28, 5.00, 1.44, 15.01, 5.35, 5.35, 3.02, 5.46;
                      3.28, 5.00, 1.44, 15.01, 5.35, 5.35, 3.02, 5.46;
                      4.88, 8.92, 2.11, 11.66, 4.08, 4.08, 4.43, 6.33;
                      4.88, 8.92, 2.11, 11.66, 4.08, 4.08, 4.43, 6.33;
                      4.88, 8.92, 2.11, 11.66, 4.08, 4.08, 4.43, 6.33];
else
