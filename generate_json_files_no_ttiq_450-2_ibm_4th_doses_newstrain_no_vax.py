...
folder = "no_ttiq_450-2_ibm_4th_doses_newstrainBA45like_cluster_no_vax"
...
for population_type in ["younger","older"]:
    ...
    for TP in TP_list:
        param_set = {"folder_suffix": "_SOCRATES_TP"+str(TP) ,
                    ...
                    "output_directory": "/scratch/cm37/tpl/covid_no_ttiq_450-2_ibm_4th_doses_newstrainBA45like_no_vax_outputs/",
                    "t_end": 700.0,
                    "seed_exposure": 225.0,
                    ...
                    "new_strain_time": 450,
                    "new_strain_initial_infections":100,
                    "ttiq": "no_ttiq",
