...
# folder = "winter_scenarios_continuous_double_exposure_no_ttiq_450-2"
folder = "winter_scenarios_continuous_double_exposure_no_ttiq_450-2_cluster"
...
# TP_list = np.sort(TP_list) # [0.8 0.9 1.  1.1 1.2 1.3 1.4 1.5 1.6] # old list

TP_list = [0.85,0.9,0.95,1.0,1.05, 1.1,1.15, 1.2,1.25, 1.3,1.35,1.4, 1.45,1.5,1.55,1.6,1.65,1.7,1.75,1.8,1.85,1.9,1.95,2.0,2.05]

# TP_list = [0.85,0.95,1.05,1.15,1.25,1.35,1.45,1.55,1.65,1.7,1.75,1.8,1.85,1.9,1.95,2.0,2.05]
print(TP_list)
...
for population_type in ["younger","older"]:
    ...
    for TP in TP_list:
        param_set = {"folder_suffix": "_SOCRATES_TP"+str(TP) ,
                    # "output_directory": "C:\\Users\\thaophuongl\\covid_continuous_simulations_double_exposure_no_ttiq_450-2_outputs\\",
                    "output_directory":"/scratch/cm37/tpl/covid_continuous_simulations_double_exposure_no_ttiq_450-2_outputs/",
                    "t_end": 700.0,
                    "seed_exposure": 225.0,
