...
folder = "winter_scenarios_continuous_double_exposure_no_ttiq_400-2"
...
TP_list = np.linspace(1.05,1.75,5)
print(TP_list)
...
for population_type in ["younger","older"]:
    ...
    for TP in TP_list:
        param_set = {"folder_suffix": "_SOCRATES_TP"+str(TP) ,
                    "output_directory": "C:\\Users\\thaophuongl\\covid_continuous_simulations_double_exposure_no_ttiq_400-2_outputs\\",
                    "t_end": 700.0,
                    "seed_exposure": 225.0,
                    "initial_infections": 100,
                    "second_seed_exposure":400.0,
