...
# days_list_name = ["_1.5-3.5years","_0-3.5years"]
one_year = 52*7
quantile_list = [0.025,0.975]

max_days = int(52*7*3.1)
days_list = [ list(range(original_program_time ,max_days))]

for days_all in days_list:
    ...
    for key,item in individual_output_names.items():
        individual_full_output_names[key]='/scratch/cm37/tpl/annual_boosting_age_scenarios_plus_time_immune_escape_t' + str(immune_escape_time) +"_outputs/"+item

    iterated_output_file_name = "age_scenarios_ALL_clinical_outcomes_totals"+days_name+".csv"
    iterated_full_output_file_name = '/scratch/cm37/tpl/annual_boosting_age_scenarios_plus_time_immune_escape_t' + str(immune_escape_time) +"_outputs/"+iterated_output_file_name
