...
for SLURM_ARRAY in range(SLURM_start,SLURM_end+1):
    ...
    if os.path.isfile(file_path):
        ...
        cmd = "sbatch --parsable --array="+str(SLURM_ARRAY)+" --export=POP="+population_type+",diffparams="+str(PARAMFILENUM)+",TPvers="+str(TP_i)+",BA45start="+str(immune_escape_time)+",bivalent="+str(bivalent_start_time)  +" bivalent_high_coverage_all.script"
