...
immune_escape_time_list = [original_program_time, original_program_time + 13*7, original_program_time + 26*7  , original_program_time + 39*7 , original_program_time + 52*7] 
...
for days_all, days_name in zip(days_list,days_list_name):
    ...
    mean_output_file_name = scenario_file_name+ "mean_clinical_outcomes_totals"+days_name+".csv"
    median_output_file_name =   scenario_file_name+ "median_clinical_outcomes_totals"+days_name+".csv"
    quantile025_output_file_name =   scenario_file_name+ "quantile_0.025_clinical_outcomes_totals"+days_name+".csv"
    quantile975_output_file_name =   scenario_file_name+ "quantile_0.975_clinical_outcomes_totals"+days_name+".csv"
