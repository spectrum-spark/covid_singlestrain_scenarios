...
def create_mega_data_frame(TP_list, TP_type_list,population_type_list,immune_escape_time,folder,
...
def plot_clinical_outcomes_over_simulations( TP_list, TP_type_list,population_type_list ,immune_escape_time ,folder,
        days_all = list(range(0,100)),
        days_name = "100_days",
        mean_or_median = "mean",
        ):
