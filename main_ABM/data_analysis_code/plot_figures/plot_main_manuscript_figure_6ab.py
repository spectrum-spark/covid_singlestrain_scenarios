#
# Produces plots for Figure 6a, 6b (boosting strategies in the low-medium coverage settings)
#
...
def plot_ribbon_infections_over_time_plus(ax, all_other_parameters, younger_or_older=["older"],immune_escape_time=546):
    ...
    leg = Legend(ax, legend_points, ["no further boosting", "pediatric vaccination","high risk boosting", "primary vaccinations"],title=title, loc="upper center",bbox_to_anchor=(bbox_x,0.99),borderaxespad=0,frameon=False,  labelcolor='w', fontsize=13,title_fontsize=14,labelspacing =0.01,handletextpad=0.1)
