#
# Produces plots Figure 5 a and 5 b in the manuscript (age-cutoff comparisons)
#
...
def plot_figure_5ab():
    ...
    plt.savefig(os.path.join(save_folder, "figure_5ab.png") , bbox_inches='tight')

    plt.savefig(os.path.join(save_folder, "figure_5ab.pdf") , bbox_inches='tight')

    plt.savefig(os.path.join(save_folder, "figure_5ab.svg") , bbox_inches='tight')

    plt.savefig(os.path.join(save_folder, "figure_5ab.eps") , bbox_inches='tight')
    plt.close()
