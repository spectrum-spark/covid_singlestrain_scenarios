...
for immune_escape_time in immune_escape_times:
    ...
    folder = "annual_boosting_age_scenarios_immune_escape_t" + str(immune_escape_time)
    # simulation output directory
    output_directory = "/scratch/cm37/tpl/annual_boosting_age_scenarios_immune_escape_t" + str(immune_escape_time) +"_outputs/"
