        ...
        for vaccination_rate in [0, 0.2, 0.5,0.8]:
            ...
            for booster_fraction in [0.8]:
                ...
                if vaccination_rate==0:
                    ...
                    boosters_only_vaccination_start_list = [-1, max(third_exposure_date-30*4,7*26*3+1),third_exposure_date+14]
                    boosters_only_vaccination_duration_list = [-1, 5*30,5*30] # [-1, 4*30,3*30]
