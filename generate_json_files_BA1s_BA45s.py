...
for new_strain_wave_start in [2,3]: # either 2 or 3, for wave 2 or wave 3
    ...
    folder = "json_BA1_BA45_wave_start_" + str(new_strain_wave_start)
    # simulation output directory
    output_directory = "/scratch/cm37/tpl/covid_BA1_BA45_wave_start_" + str(new_strain_wave_start) +"_outputs/"
