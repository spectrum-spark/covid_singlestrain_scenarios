...
for WAVESTART in WAVESTART_list:
    ...
    folder = '/scratch/cm37/tpl/reduced_cont_intros_covid_BA1_BA45_wave_start_'+str(WAVESTART)+'_outputs/'
            ...
            for PARAMFILENUM in range(0,7):
                ...
                for SLURM_ARRAY in range(1,11):
                    ...
                    if os.path.isfile(file_path):
                        ...
                        cmd = "sbatch --parsable --array="+str(SLURM_ARRAY)+" --export=POP="+population_type+",diffparams="+str(PARAMFILENUM)+",TPvers="+str(TP_i)+",BA45start="+str(WAVESTART) +" submit_function_BA1s_BA45s_reduced_cont_intros.script"
