...
header = ['population size', 'population type', 'scenario','1st year vaccination coverage','transmission potential level','boosting starts','immune escape starts', 'time period (days inclusive)', "total_median_infections_all_ages", "total_median_symptomatic_infections_all_ages","total_median_admissions_all_ages","total_median_ward_occupancy_all_ages","total_median_ICU_admissions_all_ages","total_median_ICU_occupancy_all_ages","total_median_deaths_ages_all_ages"]

for age_range in age_bands_clinical_names:
    header.append("total_median_deaths_ages_"+age_range)
...
for days_all, days_name in zip(days_list,days_list_name):
    ...
    median_output_file_name =  "low_coverage_median_clinical_outcomes_totals"+days_name+".csv"
    iterated_output_file_name = "low_coverage_ALL_clinical_outcomes_totals"+days_name+".csv"

    median_full_output_file_name = '/scratch/cm37/tpl/'+median_output_file_name 
            ...
            for vaccination_coverage_here in [0.2,0.5]:
                ...
                for boosting_group_wanted in boosting_only_group: # getting the order how I like it
                    ...
                    for paramNum in param_list:          
                        ...
                        if boosting_group_wanted==boosting_group and vaccination_coverage_here==total_vaccination_rate: # just getting the order right...
                            pass 
                        else:
                            continue 
                        ...
                        # [... 'time period (days inclusive)', "total_median_infections_all_ages", "total_median_symptomatic_infections_all_ages","total_median_admissions_all_ages","total_median_ward_occupancy_all_ages","total_median_ICU_admissions_all_ages","total_median_ICU_occupancy_all_ages"]
                        ...
                        combined_clinical_DF = combined_clinical_DF.groupby(['population size', 'population type', 'scenario','1st year vaccination coverage','transmission potential level','boosting starts','immune escape starts', 'time period']).median().reset_index()
                        ...
                        new_names =["total_median_infections_all_ages", "total_median_symptomatic_infections_all_ages","total_median_admissions_all_ages","total_median_ward_occupancy_all_ages","total_median_ICU_admissions_all_ages","total_median_ICU_occupancy_all_ages","total_median_deaths_ages_all_ages"]

                        for age_range in age_bands_clinical_names:
                            new_names.append("total_median_deaths_ages_"+age_range)
                        ...
                        mega_DF_list_median.append(combined_clinical_DF)
    ...
    mega_DF_median = pd.concat(mega_DF_list_median)

    mega_DF_median.to_csv(median_full_output_file_name ,index=False)
