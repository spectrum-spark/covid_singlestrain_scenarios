...
folder = "winter_scenarios_continuous_double_exposure_no_ttiq_400"
...
for population_type in ["younger","older"]:
    ...
    for TP in TP_list:
        param_set = {"folder_suffix": "_SOCRATES_TP"+str(TP) ,
                    "output_directory": "C:\\Users\\thaophuongl\\covid_continuous_simulations_double_exposure_no_ttiq_400_outputs\\",
                    "t_end": 700.0,
                    "seed_exposure": 225.0,
