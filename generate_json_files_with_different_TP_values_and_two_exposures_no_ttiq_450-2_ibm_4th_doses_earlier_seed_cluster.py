...
folder = "winter_scenarios_continuous_double_exposure_no_ttiq_450-2_ibm_4th_doses_earlier_seed_cluster"
...
for population_type in ["younger","older"]:
    ...
    for TP in TP_list:
        param_set = {"folder_suffix": "_SOCRATES_TP"+str(TP) ,
                    "output_directory": "/scratch/cm37/tpl/covid_continuous_simulations_double_exposure_no_ttiq_450-2_ibm_4th_doses_earlier_seed_outputs/",
                    "t_end": 700.0,
                    "seed_exposure": 182.0,
