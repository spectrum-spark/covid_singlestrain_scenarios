...
def plot_ribbon_infections_over_time(younger_or_older=["younger"],immune_escape_wave_start=2):
...
plot_ribbon_infections_over_time(younger_or_older=["younger"],immune_escape_wave_start=3)
plot_ribbon_infections_over_time(younger_or_older=["older"],immune_escape_wave_start=3)
...
plot_ribbon_infections_over_time(younger_or_older=["younger"],immune_escape_wave_start=2)
plot_ribbon_infections_over_time(younger_or_older=["older"],immune_escape_wave_start=2)
