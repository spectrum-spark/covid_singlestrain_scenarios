...
int main(int argc, char *argv[])
{
  ...
  double first_exposure_time = sim_params_json["first_exposure_time"];
  int first_exposure_infections = sim_params_json["first_exposure_infections"];
  bool first_catch_exposure = false;

  double second_exposure_time = sim_params_json["second_exposure_time"];
  int second_exposure_infections = sim_params_json["second_exposure_infections"];
  bool second_catch_exposure = false;

  double third_exposure_time = sim_params_json["third_exposure_time"];
  int third_exposure_infections = sim_params_json["third_exposure_infections"];
  bool third_catch_exposure = false;
  ...
  while (t < second_exposure_time)
  {
    ...
    while (t < t_vaccine)
    {
      ...
      if (t >= first_exposure_time && !(first_catch_exposure))
      {
        ...
        while (initial_infections < first_exposure_infections)
        {
  ...
  while (t < third_exposure_time)
  {
    ...
    while (t < t_vaccine)
    {
      ...
      else if (new_strain_wave_start==3){
