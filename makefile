...
clean: 
	...
	rm build/* RunWinter RunContinuous RunContinuousDoubleExposure RunContinuousFirstAndContExposure RunContinuousContExposure RunContinuousDoubleExposureNoTTIQ
