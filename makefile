...
all: $(OBJECTS)
	...
	$(CXX) $(CPPFLAGS) -o RunContinuousDoubleExplosure main_continuous_simulation_double_exposure.cpp $(OBJECTS) 
...
clean: 
	...
	rm build/* RunWinter RunContinuous RunContinuousDoubleExplosure
