...
folder = "C:\\Users\\thaophuongl\\covid-abm\\winter_wave_scenarios\\initial-and-during_vax_infect_scenario1_sim_params_v1"

folder = "C:\\Users\\thaophuongl\\covid-abm\\winter_wave_scenarios\\initial-and-during_vax_infect_scenario1_older_sim_params_v1"
...
savefilename <- paste0(test,".csv",sep="")
print(savefilename)
# library(dplyr)
# library(readr)
# 
